    ...
    if(query){
      client.fetch(query)
        .then((data) => {
          ...
          if(data[0]){
            let query1 = pinDetailMorePinQuery(data[0]);
      ...
      <div className="flex xl:flex-row flex-col m-auto bg-white" style={{maxWidth: '1500px', borderRadius: '32px'}}>
        ...
        <div className="w-full p-5 flex-1 xl:min-w-620">
          <div className="flex items-center justify-between">
            ...
            <a href={pinDetail.destination} target="_blank" rel="noreferrer"> {pinDetail.destination?.length > 15 ? `${pinDetail.destination.slice(0,15)}...` : pinDetail.destination}</a>
          </div>
          <div>
